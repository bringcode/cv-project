...
class Tputting_x_BallCenterMeasurer:
    ...
    def judgeMiddle(self, max_x, min_x):
        ...
        down_dist = self.img_width - max_x  # r_dist: 공을 표시한 박스 가장 오른쪽으로부터 영상 가장 오른쪽 끝까지의 거리
    ...
    def process(self):
        ...
        #         image = cv2.putText(img, 'flag Middle : {}'.format(ball_x_isMiddle), org, font,  
        ...
        # cv2.destroyAllWindows()
                    ...
                    return ball_x_isMiddle  # imshow 하려함 => 위에 있는 주석을 활성화하고, return은 주석처리
            return False
