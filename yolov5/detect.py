...
def run(
        weights= './yolov5/runs/train/direction_detect_yolov5/weights/pre_best.pt',  # model path or triton URL
...
#     parser.add_argument('--source', type=str, default= '/Users/woojin/Desktop/project/robot-project/imgs/arrow.png', help='file/dir/URL/glob/screen/0(webcam)')
